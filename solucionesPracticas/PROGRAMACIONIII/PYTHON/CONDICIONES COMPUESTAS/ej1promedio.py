...
Las f-strings se identifican por la letra "f" o "F" antes de la cadena literal. Dentro de la cadena, se utilizan llaves {} para insertar expresiones Python.
Estas expresiones pueden ser variables, cálculos matemáticos, llamadas a funciones, etc.
